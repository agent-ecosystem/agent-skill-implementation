...
**[35 checks across 10 categories](/checks/)** that need empirical testing:
...
| Content Presentation | 4 | What the model sees when a skill is discovered and activated |
...
directory on GitHub contains 25 spec-compliant skills designed to exercise these
...
1. Install the [benchmark skills](https://github.com/agent-ecosystem/agent-skill-implementation/tree/main/benchmark-skills)
   on your platform
2. Run through the test procedures for any of the 35 checks
